              ...
              <ul class="submenu">
                ...
                <ul class="submenu">
					...
					<li><a href="feesstructure.html" title="Fees Structure">FEES STRUCTURE</a></li>                            <!-- FEE STUCTURE PBM -->
					 ...
					 <li class="dir"><a href="administration.php" title="People">PEOPLE</a>                                                                                            <!-- PEOPLE -->
              <ul class="submenu">
	...
	<li class="leaf last"><a href="fms.html" title="Facility Management Services">FMS</a></li>
		 ...
		 <?php
		  if(isset($_SESSION["username"])){
			  ?>
			<li><a href="admin.php" title="Login"><?php echo $_SESSION["username"]; ?></a>                                                                                                
            <ul class="submenu">
			  <li><a href="logout.php" title="Admin logout">log-out</a></li>
